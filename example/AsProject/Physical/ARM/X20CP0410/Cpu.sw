...
<SwConfiguration xmlns="http://br-automation.co.at/AS/SwConfiguration" CpuAddress="SL1">
  ...
  <Libraries>
    ...
    <LibraryObject Name="accesslib" Source="Libraries.Loupe.accesslib.lby" Memory="UserROM" Language="IEC" Debugging="true" />
    ...
    <LibraryObject Name="brse_arl" Source="Libraries.Loupe.brse_arl.lby" Memory="UserROM" Language="Binary" Debugging="true" />
  </Libraries>
</SwConfiguration>
